...
const createGeneralInfoTemplate = () => {
  return (
...
render(tripHeaderElement, createGeneralInfoTemplate(), `afterbegin`);

const tripInfoElement = tripHeaderElement.querySelector(`.trip-info`);
...
render(dayItemElement, createEventsListTemplate(), `beforeend`);
